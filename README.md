...
- [Richard N. Taylor, Nenad Medvidovic, Eric M. Dashofy: Software Architecture: Foundations, Theory, and Practice. Wiley (2009)](https://www.wiley.com/en-us/Software+Architecture%3A+Foundations%2C+Theory%2C+and+Practice-p-9780470167748): A comprehensive and deep introduction to software architecture, which covers many different aspects of the topic, written in a more academic style, however. One of the first books to define software architecture as the set of design decisions made for the system.
